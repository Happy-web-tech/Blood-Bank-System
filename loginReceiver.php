        ...
        if(userExists($userName))
        {
            //username1->cookie for receiver and username->cookie for hospital
                if(isset($_COOKIE['username']))
                    setcookie("username", "", time()-36000,"/");//it will logout receiver
            if(checkPassword($userName, $password))
            {
                setcookie("username1", $userName, time() + 3600*24, '/');
                $WRONG_PASSWORD = 2;
                $INVALID_USER = 2;
                header("Location:./receiver.php");
            }    
...
<!-- this page is using login hospital css -->
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
...
<body>
	...
	<main class="parentContainer">
		<div class="container">
			<div class="welcome">Login Receiver</div>
